...
int32_t spibsc_dr_init(uint32_t ch_no, st_spibsc_cfg_t *spibsccfg)
{
    ...
    rza_io_reg_write_32(&SPIBSC[ ch_no ]->DRCR, SPIBSC_BURST_2, SPIBSC_DRCR_RBURST_SHIFT, SPIBSC_DRCR_RBURST);
    ...
    /* address:SDR */
    rza_io_reg_write_32(&SPIBSC[ ch_no ]->DRDRENR, SPIBSC_SDR_TRANS, SPIBSC_DRDRENR_ADDRE_SHIFT, SPIBSC_DRDRENR_ADDRE);
    /* option data:SDR */
    rza_io_reg_write_32(&SPIBSC[ ch_no ]->DRDRENR, SPIBSC_SDR_TRANS, SPIBSC_DRDRENR_OPDRE_SHIFT, SPIBSC_DRDRENR_OPDRE);
    /* data read: SDR */
    rza_io_reg_write_32(&SPIBSC[ ch_no ]->DRDRENR, SPIBSC_SDR_TRANS, SPIBSC_DRDRENR_DRDRE_SHIFT, SPIBSC_DRDRENR_DRDRE);
...
static int32_t io_spibsc_port_setting (uint32_t ch_no, int_t data_bus_width, uint32_t bsz)
{
    ...
    if(0 == ch_no)
    {
        ...
        rza_io_reg_write_16(&GPIO.PFCAE9, 0, GPIO_PFCAE9_PFCAE92_SHIFT, GPIO_PFCAE9_PFCAE92);
        rza_io_reg_write_16(&GPIO.PFCE9,  0, GPIO_PFCE9_PFCE92_SHIFT,   GPIO_PFCE9_PFCE92);
        rza_io_reg_write_16(&GPIO.PFC9,   1, GPIO_PFC9_PFC92_SHIFT,     GPIO_PFC9_PFC92);

        /* port mode : Both use mode(The 2nd both use) */
        rza_io_reg_write_16(&GPIO.PMC9,   1, GPIO_PMC9_PMC92_SHIFT,     GPIO_PMC9_PMC92);

        /* Input/output control mode : peripheral function */
        rza_io_reg_write_16(&GPIO.PIPC9,  1, GPIO_PIPC9_PIPC92_SHIFT,   GPIO_PIPC9_PIPC92);

        /* ==== P9_3 : SPBSSL_0 ==== */
        /* port function : SPBSSL_0     */
        rza_io_reg_write_16(&GPIO.PFCAE9, 0, GPIO_PFCAE9_PFCAE93_SHIFT, GPIO_PFCAE9_PFCAE93);
        rza_io_reg_write_16(&GPIO.PFCE9,  0, GPIO_PFCE9_PFCE93_SHIFT,   GPIO_PFCE9_PFCE93);
        rza_io_reg_write_16(&GPIO.PFC9,   1, GPIO_PFC9_PFC93_SHIFT,     GPIO_PFC9_PFC93);

        /* port mode : Both use mode(The 2nd both use) */
        rza_io_reg_write_16(&GPIO.PMC9,   1, GPIO_PMC9_PMC93_SHIFT,     GPIO_PMC9_PMC93);

        /* Input/output control mode : peripheral function */
        rza_io_reg_write_16(&GPIO.PIPC9,  1, GPIO_PIPC9_PIPC93_SHIFT,   GPIO_PIPC9_PIPC93);

        /* ==== P9_4 : SPBIO00_0 ==== */
        /* port function : SPBIO00_0    */
        rza_io_reg_write_16(&GPIO.PFCAE9, 0, GPIO_PFCAE9_PFCAE94_SHIFT, GPIO_PFCAE9_PFCAE94);
        rza_io_reg_write_16(&GPIO.PFCE9,  0, GPIO_PFCE9_PFCE94_SHIFT,   GPIO_PFCE9_PFCE94);
        rza_io_reg_write_16(&GPIO.PFC9,   1, GPIO_PFC9_PFC94_SHIFT,     GPIO_PFC9_PFC94);

        /* port mode : Both use mode(The 2nd both use) */
        rza_io_reg_write_16(&GPIO.PMC9,   1, GPIO_PMC9_PMC94_SHIFT,     GPIO_PMC9_PMC94);

        /* Input/output control mode : peripheral function */
        rza_io_reg_write_16(&GPIO.PIPC9,  1, GPIO_PIPC9_PIPC94_SHIFT,   GPIO_PIPC9_PIPC94);
        ...
        rza_io_reg_write_16(&GPIO.PFC9,   1, GPIO_PFC9_PFC95_SHIFT,     GPIO_PFC9_PFC95);

        /* port mode : Both use mode(The 2nd both use) */
        rza_io_reg_write_16(&GPIO.PMC9,   1, GPIO_PMC9_PMC95_SHIFT,     GPIO_PMC9_PMC95);

        /* Input/output control mode : peripheral function */
        rza_io_reg_write_16(&GPIO.PIPC9,  1, GPIO_PIPC9_PIPC95_SHIFT,   GPIO_PIPC9_PIPC95);

        if(data_bus_width == SPIBSC_4BIT)
        {
            /* ==== P9_6 : SPBIO20_0 ==== */
            /* port function : SPBIO20_0    */
            rza_io_reg_write_16(&GPIO.PFCAE9, 0, GPIO_PFCAE9_PFCAE96_SHIFT, GPIO_PFCAE9_PFCAE96);
            rza_io_reg_write_16(&GPIO.PFCE9,  0, GPIO_PFCE9_PFCE96_SHIFT,   GPIO_PFCE9_PFCE96);
            rza_io_reg_write_16(&GPIO.PFC9,   1, GPIO_PFC9_PFC96_SHIFT,     GPIO_PFC9_PFC96);

            /* port mode : Both use mode(The 2nd both use) */
            rza_io_reg_write_16(&GPIO.PMC9,   1, GPIO_PMC9_PMC96_SHIFT,     GPIO_PMC9_PMC96);

            /* Input/output control mode : peripheral function */
            rza_io_reg_write_16(&GPIO.PIPC9,  1, GPIO_PIPC9_PIPC96_SHIFT,   GPIO_PIPC9_PIPC96);

            /* ==== P9_7 : SPBIO30_0 ==== */
            /* port function : SPBIO30_0    */
            rza_io_reg_write_16(&GPIO.PFCAE9, 0, GPIO_PFCAE9_PFCAE97_SHIFT, GPIO_PFCAE9_PFCAE97);
            rza_io_reg_write_16(&GPIO.PFCE9,  0, GPIO_PFCE9_PFCE97_SHIFT,   GPIO_PFCE9_PFCE97);
            rza_io_reg_write_16(&GPIO.PFC9,   1, GPIO_PFC9_PFC97_SHIFT,     GPIO_PFC9_PFC97);

            /* port mode : Both use mode(The 2nd both use) */
            rza_io_reg_write_16(&GPIO.PMC9,   1, GPIO_PMC9_PMC97_SHIFT,     GPIO_PMC9_PMC97);

            /* Input/output control mode : peripheral function */
            rza_io_reg_write_16(&GPIO.PIPC9,  1, GPIO_PIPC9_PIPC97_SHIFT,   GPIO_PIPC9_PIPC97);

            if(SPIBSC_CMNCR_BSZ_DUAL == bsz)
            {
                /* ==== P2_12 : SPBIO01_0 ==== */
                /* port function : SPBIO01_0    */
                rza_io_reg_write_16(&GPIO.PFCAE2, 0, GPIO_PFCAE2_PFCAE212_SHIFT, GPIO_PFCAE2_PFCAE212);
                rza_io_reg_write_16(&GPIO.PFCE2,  1, GPIO_PFCE2_PFCE212_SHIFT,   GPIO_PFCE2_PFCE212);
                rza_io_reg_write_16(&GPIO.PFC2,   1, GPIO_PFC2_PFC212_SHIFT,     GPIO_PFC2_PFC212);

                /* port mode : Both use mode(The 4th both use) */
                rza_io_reg_write_16(&GPIO.PMC2,   1, GPIO_PMC2_PMC212_SHIFT,     GPIO_PMC2_PMC212);

                /* Input/output control mode : peripheral function */
                rza_io_reg_write_16(&GPIO.PIPC2,  1, GPIO_PIPC2_PIPC212_SHIFT,   GPIO_PIPC2_PIPC212);

                /* ==== P2_13 : SPBIO11_0 ==== */
                /* port function : SPBIO11_0    */
                rza_io_reg_write_16(&GPIO.PFCAE2, 0, GPIO_PFCAE2_PFCAE213_SHIFT, GPIO_PFCAE2_PFCAE213);
                rza_io_reg_write_16(&GPIO.PFCE2,  1, GPIO_PFCE2_PFCE213_SHIFT,   GPIO_PFCE2_PFCE213);
                rza_io_reg_write_16(&GPIO.PFC2,   1, GPIO_PFC2_PFC213_SHIFT,     GPIO_PFC2_PFC213);

                /* port mode : Both use mode(The 4th both use) */
                rza_io_reg_write_16(&GPIO.PMC2,   1, GPIO_PMC2_PMC213_SHIFT,     GPIO_PMC2_PMC213);

                /* Input/output control mode : peripheral function */
                rza_io_reg_write_16(&GPIO.PIPC2,  1, GPIO_PIPC2_PIPC213_SHIFT,   GPIO_PIPC2_PIPC213);

                /* ==== P2_14 : SPBIO21_0 ==== */
                /* port function : SPBIO21_0    */
                rza_io_reg_write_16(&GPIO.PFCAE2, 0, GPIO_PFCAE2_PFCAE214_SHIFT, GPIO_PFCAE2_PFCAE214);
                rza_io_reg_write_16(&GPIO.PFCE2,  1, GPIO_PFCE2_PFCE214_SHIFT,   GPIO_PFCE2_PFCE214);
                rza_io_reg_write_16(&GPIO.PFC2,   1, GPIO_PFC2_PFC214_SHIFT,     GPIO_PFC2_PFC214);

                /* port mode : Both use mode(The 4th both use) */
                rza_io_reg_write_16(&GPIO.PMC2,   1, GPIO_PMC2_PMC214_SHIFT,     GPIO_PMC2_PMC214);

                /* Input/output control mode : peripheral function */
                rza_io_reg_write_16(&GPIO.PIPC2,  1, GPIO_PIPC2_PIPC214_SHIFT,   GPIO_PIPC2_PIPC214);

                /* ==== P2_15 : SPBIO31_0 ==== */
                /* port function : SPBIO31_0    */
                rza_io_reg_write_16(&GPIO.PFCAE2, 0, GPIO_PFCAE2_PFCAE215_SHIFT, GPIO_PFCAE2_PFCAE215);
                rza_io_reg_write_16(&GPIO.PFCE2,  1, GPIO_PFCE2_PFCE215_SHIFT,   GPIO_PFCE2_PFCE215);
                rza_io_reg_write_16(&GPIO.PFCE2,  1, GPIO_PFCE2_PFCE215_SHIFT,   GPIO_PFCE2_PFCE215);
                rza_io_reg_write_16(&GPIO.PFC2,   1, GPIO_PFC2_PFC215_SHIFT,     GPIO_PFC2_PFC215);

                /* port mode : Both use mode(The 4th both use) */
                rza_io_reg_write_16(&GPIO.PMC2,   1, GPIO_PMC2_PMC215_SHIFT,     GPIO_PMC2_PMC215);

                /* Input/output control mode : peripheral function */
                rza_io_reg_write_16(&GPIO.PIPC2,  1, GPIO_PIPC2_PIPC215_SHIFT,   GPIO_PIPC2_PIPC215);
            }
        }
    }
    else
    {
        ...
        rza_io_reg_write_16(&GPIO.PFCE8,  1, GPIO_PFCE8_PFCE812_SHIFT,   GPIO_PFCE8_PFCE812);
        ...
        rza_io_reg_write_16(&GPIO.PFCE8,  1, GPIO_PFCE8_PFCE813_SHIFT,   GPIO_PFCE8_PFCE813);
        ...
        rza_io_reg_write_16(&GPIO.PFCE8,  1, GPIO_PFCE8_PFCE814_SHIFT,   GPIO_PFCE8_PFCE814);
        ...
        rza_io_reg_write_16(&GPIO.PFCE8,  1, GPIO_PFCE8_PFCE815_SHIFT,   GPIO_PFCE8_PFCE815);
        ...
        if(SPIBSC_4BIT == data_bus_width)
        {
            ...
            rza_io_reg_write_16(&GPIO.PFCE8,  1, GPIO_PFCE8_PFCE810_SHIFT,   GPIO_PFCE8_PFCE810);
            ...
            rza_io_reg_write_16(&GPIO.PFCE8,  1, GPIO_PFCE8_PFCE811_SHIFT,   GPIO_PFCE8_PFCE811);
