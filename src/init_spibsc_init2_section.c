...
extern uint32_t __code_oled_start__;
extern uint32_t __code_oled_end__;
extern uint32_t __code_oled_src__;
...
/*
	...
	*/
...

	{
		...
		ram_start       = &__code_oled_start__;
		ram_end       = &__code_oled_end__;
